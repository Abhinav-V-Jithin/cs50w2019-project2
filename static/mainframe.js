...
class mainframe_controller
{
  ...
  manage_navigations()
  {
      ...
      document.querySelector('#text').innerHTML = `Welcome back ${localStorage.getItem('username')}`;
      ...
      channels_nav.onclick = () =>
      {
        ...
        {
          channel_wrapper.style.height = window.innerHeight + "px";
        }
      };
      privates_nav.onclick = () =>
      {
        ...
        {
          private_wrapper.style.height = window.innerHeight + "px";
        }
      };
  ...
  add_privates(list)
  {
    ...
    document.querySelector('.private1').onclick = () =>
    {
      ...
      if(window.innerWidth < 1000)
      {
        ...
        document.querySelector('#privates-channels-wrapper').hidden = true;
        document.querySelector('#channels-heading').hidden = true;
        document.querySelector('#message-wrapper').hidden = false;
        document.querySelector('#message-wrapper').style.width = "100%";
        document.querySelector('.message-view').style.marginLeft = "0%";
        document.querySelector('.message-view').style.width = "100%";
        document.querySelector('#send-message').hidden = false;
        document.querySelector('#send-message').style.width = "75%";
        document.querySelector('#send-message').style.marginLeft = "0%";
        document.querySelector('#welcome').hidden = false;
        document.querySelector('#welcome').style.marginLeft = "0%";
  ...
  mobile_startup()
  {
    document.querySelector('#message-wrapper').hidden = true;
    document.querySelector('.horizontal-divider').hidden = true;
    document.querySelector('.input-group').hidden = true;
    document.querySelector('#welcome').hidden = true;
    document.querySelector('#vertical-divider').hidden = true;
    document.querySelector('.bar').style.width = "100%";
    document.querySelectorAll('li').forEach(li =>
    {
      li.style.width = "50%";
    });
    document.querySelector('#privates-channels-wrapper').style.width = "100%";
    document.querySelector('#channels-heading').style.width = "100%";
    document.querySelector('.channels-wrapper').style.height = window.innerHeight + "px";
    document.querySelector('.privates-wrapper').style.height = window.innerHeight + "px";
    try
    {
      document.querySelector('.channel1').style.marginTop = document.querySelector('#channels-heading').offsetHeight + document.querySelector('.bar').offsetHeight + "px";
    }
    catch(e){}
    try
    {
      document.querySelector('.private1').style.marginTop = document.querySelector('#channels-heading').offsetHeight + document.querySelector('.bar').offsetHeight + "px";
    }
    catch(e){}
  }
}
...
document.addEventListener('DOMContentLoaded', ()=>
{
  ...
  back.onclick = () =>
  {
    document.querySelector('#privates-channels-wrapper').hidden = false;
    document.querySelector('#channels-heading').hidden = false;
